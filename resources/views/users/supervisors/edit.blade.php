                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::open(['action' =>['SupervisorsController@update', $user->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    {{Form::label('name', 'Full Name')}}
                                    {{Form::text('name', $user->name, ['class' => 'form-control ', 'placeholder' => 'Enter Full Name','id' => 'exampleInputName'])}}
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::email('email', $user->email, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Enter email'])}}
                                    @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
